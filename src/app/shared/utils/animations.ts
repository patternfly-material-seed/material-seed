...
export const Animations = [
    ...
    trigger('routerTransitionLeft', [
        ...
        transition('* => *', [
            query('ms-content > :enter, ms-content > :leave', [
                style({
                    position: 'absolute',
                    top: 0,
                    bottom: 0,
            ...
            sequence([
                ...
                query('ms-content > :leave', animateChild(), { optional: true }),
                query('ms-content > :enter', animateChild(), { optional: true })
            ])
        ])
    ]),
